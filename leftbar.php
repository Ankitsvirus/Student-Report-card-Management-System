...
<li class="has-children">
                                        <a href="#"><i class="fa fa-info-circle"></i> <span>Result By Subject</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="add-result-sub.php"><i class="fa fa-bars"></i> <span>Add Result By Sub</span></a></li>
                                            <li><a href="manage-results-sub.php"><i class="fa fa fa-server"></i> <span>Manage Result By Sub</span></a></li>
