...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="index.php">SRMS-(Student Result Management System) By Ankit Shukla (20MCA008)</a>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img\an6.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img\an2.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img\an3.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img\an4.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img\an7.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img\an5.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
